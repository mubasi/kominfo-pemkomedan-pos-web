    ...
    <b-card>
      <div slot="header">
        ...
        <div class="card-header-actions" style="height: 21px;">
          <router-link :to="'/panel/main-data/lembaga-pengangkatan'" class="btn btn-sm btn-warning text-white"><i class="fa fa-arrow-left" /> Kembali</router-link>
        </div>
      </div>
      ...
      axios.post(this.baseUrl, this.form)
        .then(function (response) {
          ...
          self.$swal({
            ...
            if (result.value) {
              // self.$route
              self.$router.push('/panel/main-data/lembaga-pengangkatan');
            }
          });
        })
