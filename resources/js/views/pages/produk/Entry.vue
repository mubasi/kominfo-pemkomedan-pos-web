              ...
              <b-col md="12" v-if="options_kategori.length > 0">
                ...
                >
                  <b-form-checkbox-group
                    size="md"
                    v-model="form_kategori_produk.kategori"
                ...
                <div
                  ...
                  v-if="errors_kategori_produk != null"
                >
                  <ul>
                    <li
                      v-for="(item, index) in errors_kategori_produk.kategori"
                      :key="index"
                    >
                      {{ item }}
                    </li>
        ...
        .then((response) => {
          ...
          if (data.kategori_produk_relasi.length > 0) {
            ...
            data.kategori_produk_relasi.forEach((element) => {
              this.form_kategori_produk.kategori.push(
                element.kategori_produk.id
              );
            });
          }
    ...
    async saveinfoproduk() {
      ...
      await axios
        ...
        .then(function (response) {
          ...
          self.form_kategori_produk.id_produk = id_produk;
          // return true;
