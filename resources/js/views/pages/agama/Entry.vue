    ...
    <b-card>
      ...
      <form @submit.prevent="submit">
        ...
        <b-form-row class="mb-1">
          ...
          <b-col md="10">
            <b-form-input v-model="form.nama" type="text" placeholder="Masukkan Nama Agama"></b-form-input>
...
export default {
  ...
  methods: {
    petchData(id) {
      ...
      axios.get('/api/agama/' + id).then((response) => {
        this.$swal.close();
      ...
      axios.post(url, this.form)
        .then(function (response) {
          ...
          self.$swal({
            ...
            if (result.value) {
              // self.$route
              self.$router.push('/panel/main-data/agama');
            }
          });
        })
