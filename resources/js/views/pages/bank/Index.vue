  ...
  <b-card>
    <div slot="header">
      ...
      <div class="card-header-actions" style="height: 21px;">
        ...
        <router-link :to="'/panel/main-data/bank/add'" class="btn btn-sm btn-primary"><i class="fa fa-edit" /> Entry Data</router-link>
      </div>
    </div>
    <app-datatable v-if="fields" :editUrl="'/panel/main-data/bank/'" :deleteData="deleteRow" :isBusy="isBusy" :items="items" :fields="fields" :meta="meta" @per_page="handlePerPage" @pagination="handlePagination" @search="handleSearch" @sort="handleSort" />
...
export default {
  ...
  methods: {
    ...
    prosesDelete(id) {
      ...
      axios.delete('/api/bank/' + id).then((response) => {
        this.$swal({
